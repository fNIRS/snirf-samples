...
This repository contains 3 types of data files
...
- The text-based [JSNIRF](https://github.com/OpenJData/jsnirf) data files 
  (`.jnirf`) are actually [JSON](http://json.org) files with 
...
- The binary [JSNIRF](https://github.com/OpenJData/jsnirf) data files 
  (`.bnirf`) are actually [BJData/UBJSON](https://github.com/OpenJData/bjdata) 
